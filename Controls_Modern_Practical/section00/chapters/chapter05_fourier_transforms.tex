...
\input{figures/fig_ch00_fourier_series.tex}
...
\input{figures/fig_ch00_spectrum_visualization.tex}
...
\caption{Nyquist sampling and aliasing in the Fourier domain.}
\label{fig:nyquist_sampling_fourier}
\end{figure}
