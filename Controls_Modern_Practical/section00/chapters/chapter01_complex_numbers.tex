...
\input{figures/fig_ch00_complex_multiplication.tex}
\input{figures/fig_ch00_complex_conjugate.tex}
\input{figures/fig_ch00_roots_of_unity.tex}
...
\textbf{Geometric interpretation:} The three roots are equally spaced on a circle of radius $2$ in the complex plane, separated by $120°$ (i.e., $2\pi/3$ radians).
\end{examplebox}
