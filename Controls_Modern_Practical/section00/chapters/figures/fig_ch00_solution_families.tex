...
\addplot[Rose, very thick, domain=0:6, samples=150] {1 + (0.5 - 1)*exp(-x)};
...
\node[circle, fill, Rose, minimum size=5pt] at (axis cs:0, 0.5) {};
...
\draw[Rose, thick, ->] (axis cs:1.5, 0.7) -- (axis cs:1.7, 0.82);
\node[Rose, font=\tiny, below] at (axis cs:1.6, 0.7) {growth};
