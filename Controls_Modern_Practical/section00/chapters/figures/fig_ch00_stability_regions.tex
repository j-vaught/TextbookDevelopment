...
\begin{tikzpicture}[scale=1.1]
    ...
    \node[font=\bfseries, UofSCRose] at (1.5, 3.0) {UNSTABLE};
    \node[font=\small, UofSCRose] at (1.5, 2.5) {(Right Half-Plane)};
    ...
    % Unstable real pole
    \node[circle, fill, UofSCRose, minimum size=8pt] at (1, 0) {};
    \node[above, font=\footnotesize, UofSCRose] at (1, 0.3) {$p_4 = +1$};
    ...
    \begin{scope}[xshift=-4.5cm, yshift=-2.8cm]
        ...
        \node[circle, fill, UofSCRose, minimum size=5pt] at (1.5, 1.0) {};
