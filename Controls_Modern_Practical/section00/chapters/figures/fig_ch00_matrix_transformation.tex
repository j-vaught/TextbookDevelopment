...
\begin{scope}[xshift=10cm]
    \node[font=\bfseries] at (1.5, 3.8) {(c) Rotation ($45°$)};
    ...
    \node[UofSCAtlantic, font=\small] at (0.7, 0.25) {$45°$};
    ...
    % Matrix label
    \node[align=center, font=\footnotesize] at (0.5, -1.2) {$\mR = \begin{bmatrix} \cos 45° & -\sin 45° \\ \sin 45° & \cos 45° \end{bmatrix}$};
\end{scope}
...
\begin{scope}[xshift=7cm, yshift=-6.5cm]
    ...
    % Matrix label
    \node[align=center, font=\footnotesize] at (3, -1.2) {$\mM = \mR(30°) \cdot \mS = \begin{bmatrix} 1.30 & -0.40 \\ 0.75 & 0.69 \end{bmatrix}$};
\end{scope}
