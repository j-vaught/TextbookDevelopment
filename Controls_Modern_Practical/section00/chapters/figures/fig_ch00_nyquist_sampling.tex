...
\caption{Illustration of the Nyquist sampling theorem and aliasing. \textbf{Top:} Adequate sampling at $f_s = 10$ Hz captures a 3 Hz signal correctly. \textbf{Middle:} Undersampling at $f_s = 4$ Hz causes aliasing---the 3 Hz signal appears as a 1 Hz signal (Rose). \textbf{Bottom left:} Frequency spectrum with adequate sampling shows original frequencies within the Nyquist band (Horseshoe shading). \textbf{Bottom right:} Undersampling causes high frequencies to fold into the Nyquist band, creating false low-frequency components. The Garnet box summarizes the Nyquist-Shannon theorem.}
\label{fig:nyquist_sampling}
\end{figure}
