...
\addplot[Rose, very thick, domain=0:15, samples=300, smooth, variable=\t,
    decoration={markings, mark=at position 0.15 with {\arrow{>}}, mark=at position 0.4 with {\arrow{>}}, mark=at position 0.7 with {\arrow{>}}}, postaction={decorate}]
...
\node[circle, fill=Rose, minimum size=5pt, inner sep=0pt] at (axis cs:-1,-1.8) {};
...
\node[Rose, font=\footnotesize, below left] at (axis cs:-1,-1.9) {$\vecx_0$};
...
\begin{scope}[xshift=8.2cm, yshift=1.5cm]
    ...
    \draw[very thick, Rose] (0, 0.3) -- (0.8, 0.3);
