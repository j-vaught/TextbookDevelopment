...
\end{tikzpicture}
\caption{The fifth roots of unity. The $n$th roots of unity are $n$ complex numbers evenly distributed on the unit circle, satisfying $z^n = 1$. For $n=5$, these roots $\omega_k = \ee^{\jj 2\pi k/5}$ are separated by angles of $2\pi/5 = 72^{\circ}$ and form a regular pentagon. The root $\omega_0 = 1$ always lies on the positive real axis.}
