...
The quarter-car model extends naturally to heavier vehicles. Figure~\ref{fig:truck_suspension} shows a semi-truck where tandem rear axles distribute the trailer load. Each axle requires independent suspension analysis, with the additional complexity of load transfer between axles during braking and acceleration.
